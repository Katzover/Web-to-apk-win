...
> **Note:** All commands below use `.\make.ps1` instead of `./make.sh`.
...
- `.\make.ps1 build [config]` - Apply configuration and build
- `.\make.ps1 keygen` - Generate signing key
- `.\make.ps1 test` - Install and test APK on connected device
- `.\make.ps1 clean` - Clean build files
- `.\make.ps1 apk` - Build APK without apply_config
- `.\make.ps1 apply_config` - Apply settings from configuration file
- `.\make.ps1 get_java` - Download OpenJDK 17 locally
